...
//! Generic benchmarking harness for VKD implementations.

pub mod stats;

pub use stats::ProofSizeOf;

use akd_core::types::{AkdLabel, AkdValue};
use async_trait::async_trait;

use crate::traits::VerifiableKeyDirectory;

/// Trait that VKD implementations provide to set up benchmark fixtures.
#[async_trait]
pub trait VkdBenchmarkSetup: 'static {
    /// The VKD directory type being benchmarked.
    type Directory: VerifiableKeyDirectory;
