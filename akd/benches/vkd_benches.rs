...
#[async_trait]
impl vkd::bench::VkdBenchmarkSetup for AkdBenchSetup {
...
fn main() {
    ...
    vkd::bench::bench_publish::<AkdBenchSetup>(&mut criterion);
    vkd::bench::bench_lookup::<AkdBenchSetup>(&mut criterion);
    vkd::bench::bench_lookup_verify::<AkdBenchSetup, _>(&mut criterion, akd_lookup_proof_size);
    vkd::bench::bench_key_history::<AkdBenchSetup>(&mut criterion);
    vkd::bench::bench_audit::<AkdBenchSetup>(&mut criterion);
    vkd::bench::bench_audit_verify::<AkdBenchSetup>(&mut criterion);
